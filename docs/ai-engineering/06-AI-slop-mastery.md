...
- **Zen**: OpenCode's own model provider layer, which offers free models like DeepSeek V4 or BigPickle that are completely free.
- **other providers**: Via OAuth or bringing your own API key, you can use other providers with open code like OpenAI or Claude.
